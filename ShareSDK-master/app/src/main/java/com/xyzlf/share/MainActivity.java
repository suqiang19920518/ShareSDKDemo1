...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * 分享大图，大图分享支持微信，微信朋友圈，微博，QQ，其他渠道不支持
     *
     * 分享大图注意点
...
//        testBean.setImgUrl("/storage/A283-CC03/DCIM/Camera/1.jpg"); //本地地址，图片必须经过压缩处理

        /** 如果你要分享的图片是Bitmap，你可以如下使用 **/
        Bitmap bitmap = ResourcesUtils.resourceToBitmap(this, R.mipmap.logo_company);
